...
class SEQ_old():
    def __init__(self, fullfilename=".\\Data_Seq_8\\_Carsten_FRA1fertig.csv", sequence_length=8, path_output=".\\Data_python", _id="nox_id", show_images = False, target_color = 8):        
        ...
        print(f"cor_seq_time_paradigmen: type: {type(self.cor_seq_time_paradigmen)}  {self.cor_seq_time_paradigmen}")
        print(f"ipi_cor_paradigmen: type: {type(self.ipi_cor_paradigmen)}  {self.ipi_cor_paradigmen}")
